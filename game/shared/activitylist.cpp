...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_DRYFIRE2 );
...
//===========================
	...
	REGISTER_SHARED_ACTIVITY( ACT_RANGE_ATTACK_PUMPSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_RANGE_ATTACK_SHOTGUN_LOW );
	REGISTER_SHARED_ACTIVITY( ACT_RANGE_ATTACK_COACHGUN );
	REGISTER_SHARED_ACTIVITY( ACT_RANGE_ATTACK_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_RANGE_ATTACK_PISTOL2 );
	REGISTER_SHARED_ACTIVITY( ACT_RANGE_ATTACK_DUALPISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_RANGE_ATTACK_DUALPISTOL2 );
	...
	REGISTER_SHARED_ACTIVITY( ACT_GESTURE_RANGE_ATTACK_DUALPISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_GESTURE_RANGE_ATTACK_DUALPISTOL2 );
...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_PISTOL_RH_AIM );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_RUN_PISTOL_RH_AIM );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RANGE_ATTACK_PISTOL2 );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RELOAD_PISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RELOAD_PISTOL_LONG );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RELOAD_PISTOL_MID );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_JUMP_PISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_PISTOL_LEFT );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_RUN_PISTOL_LEFT );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_CROUCH_PISTOL_LEFT );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_WALK_CROUCH_PISTOL_LEFT );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RANGE_ATTACK_PISTOL_LEFT );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RANGE_ATTACK_PISTOL2_LEFT );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RELOAD_PISTOL_LEFT );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RELOAD_PISTOL_LEFT_LONG );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RELOAD_PISTOL_LEFT_MID );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_JUMP_PISTOL_LEFT );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_PUMPSHOTGUN );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_RUN_PUMPSHOTGUN );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_CROUCH_PUMPSHOTGUN );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_WALK_CROUCH_PUMPSHOTGUN );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RANGE_ATTACK_PUMPSHOTGUN );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RELOAD_PUMPSHOTGUN );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_JUMP_PUMPSHOTGUN );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RANGE_ATTACK_KNIFE2 );
	...
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_WHISKEY );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_RUN_WHISKEY );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_CROUCH_WHISKEY );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_WALK_CROUCH_WHISKEY );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RANGE_ATTACK_WHISKEY );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RANGE_ATTACK_WHISKEY2 );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_JUMP_WHISKEY );

	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_DUALPISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_RUN_DUALPISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_IDLE_CROUCH_DUALPISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_WALK_CROUCH_DUALPISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RANGE_ATTACK_DUALPISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RANGE_ATTACK_DUALPISTOL2 );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RELOAD_DUALPISTOL );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_GESTURE_RELOAD_DUALNAVY );
	REGISTER_SHARED_ACTIVITY ( ACT_HL2MP_JUMP_DUALPISTOL );
	...
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_RAGGED );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_DUALPISTOL_RAGGED );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_RIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_AXE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_KNIFE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_FISTS );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_PISTOL_LEFT );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_DYNAMITE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_NOWEAPON );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_BOW );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SLIDE_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_ONHORSE_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_ONHORSE_RIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_ONHORSE_AXE );
	REGISTER_SHARED_ACTIVITY( ACT_ONHORSE_KNIFE );
	REGISTER_SHARED_ACTIVITY( ACT_ONHORSE_FISTS );
	REGISTER_SHARED_ACTIVITY( ACT_ONHORSE_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_ONHORSE_PISTOL_LEFT );
	REGISTER_SHARED_ACTIVITY( ACT_ONHORSE_PISTOL_DUAL );
	REGISTER_SHARED_ACTIVITY( ACT_ONHORSE_PISTOL_AIM_RH );
	REGISTER_SHARED_ACTIVITY( ACT_ONHORSE_DYNAMITE );
	REGISTER_SHARED_ACTIVITY( ACT_ONHORSE_NOWEAPON );
	REGISTER_SHARED_ACTIVITY( ACT_ONHORSE_BOW );
	REGISTER_SHARED_ACTIVITY( ACT_ONHORSE_SHOTGUN );
