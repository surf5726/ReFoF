#ifndef FOF_WEAPON_BOW_BLACK_H
#define FOF_WEAPON_BOW_BLACK_H
#ifdef _WIN32
#pragma once
#endif
...
#ifdef CLIENT_DLL
#define CWeaponBowarrowBlack C_WeaponBowarrowBlack
#endif

class CWeaponBowarrowBlack : public CBaseHL2MPCombatWeapon
{
public:
	DECLARE_CLASS( CWeaponBowarrowBlack, CBaseHL2MPCombatWeapon );
	DECLARE_NETWORKCLASS();
	DECLARE_PREDICTABLE();

	CWeaponBowarrowBlack();
	int FoFWeaponWeight( void ) const OVERRIDE { return 3; }
	float FoFSightExpandRate( void ) const OVERRIDE { return 1.9f; }
