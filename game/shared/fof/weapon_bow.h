#ifndef FOF_WEAPON_BOW_H
#define FOF_WEAPON_BOW_H
#ifdef _WIN32
#pragma once
#endif
...
#ifdef CLIENT_DLL
#define CWeaponBowarrow C_WeaponBowarrow
#endif

class CWeaponBowarrow : public CBaseHL2MPCombatWeapon
{
public:
	DECLARE_CLASS( CWeaponBowarrow, CBaseHL2MPCombatWeapon );
	DECLARE_NETWORKCLASS();
	DECLARE_PREDICTABLE();

	CWeaponBowarrow();
	int FoFWeaponWeight( void ) const OVERRIDE { return 3; }
	float FoFSightExpandRate( void ) const OVERRIDE { return 1.45f; }
