#ifndef FOF_WEAPON_DYNAMITE_BLACK_H
#define FOF_WEAPON_DYNAMITE_BLACK_H
#ifdef _WIN32
#pragma once
#endif
...
#ifdef CLIENT_DLL
#define CWeaponDynamiteBlack C_WeaponDynamiteBlack
#ifndef CFoF_Player
...
class CWeaponDynamiteBlack : public CBaseHL2MPCombatWeapon
{
public:
	DECLARE_CLASS( CWeaponDynamiteBlack, CBaseHL2MPCombatWeapon );
	DECLARE_NETWORKCLASS();
	DECLARE_PREDICTABLE();

	CWeaponDynamiteBlack();
...
private:
	bool IsBlackDynamite() const { return true; }
	const char *ProjectileClassname() const { return "dynamite_black"; }
...
#endif // FOF_WEAPON_DYNAMITE_BLACK_H
