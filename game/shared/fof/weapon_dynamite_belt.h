#ifndef FOF_WEAPON_DYNAMITE_BELT_H
#define FOF_WEAPON_DYNAMITE_BELT_H
#ifdef _WIN32
#pragma once
#endif
...
#ifdef CLIENT_DLL
#define CWeaponDynamiteBelt C_WeaponDynamiteBelt
#ifndef CFoF_Player
...
class CWeaponDynamiteBelt : public CBaseHL2MPCombatWeapon
{
public:
	DECLARE_CLASS( CWeaponDynamiteBelt, CBaseHL2MPCombatWeapon );
...
#ifdef CLIENT_DLL
	float m_flOwnerAccuracy;
#else
	CNetworkVar( float, m_flOwnerAccuracy );
#endif

private:
	bool IsBlackDynamite() const { return false; }
	const char *ProjectileClassname() const { return "dynamite_yellow"; }
...
#endif // FOF_WEAPON_DYNAMITE_BELT_H
